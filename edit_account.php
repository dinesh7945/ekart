...
//     $get_customer = "SELECT * from customer where customer email='$customer_email'";
...
//     $id = $row['customer_id'];
//     $fname = $row['customer_fullname'];
//     $email = $row['customer_email'];
//     $pass = $row['customer_pass'];
//     $add = $row['customer_add'];
//     $address = $row['customer_address'];
//     $city = $row['customer_city'];
//     $state = $row['customer_state'];
//     $code = $row['customer_code'];
//     $country = $row['customer_country'];
//     $info = $row['customer_info'];
...
//     $update_c = "SELECT * from customer set 
//     customere_fullname='c_fname', customer_email='$c_email', 
